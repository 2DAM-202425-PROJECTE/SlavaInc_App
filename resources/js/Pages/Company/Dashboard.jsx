...
import {
    PlusIcon,
    UsersIcon,                  // Reemplaza UserGroupIcon
    BuildingOffice2Icon,        // Reemplaza BuildingOfficeIcon
    PhoneIcon,
    MapPinIcon,
    PencilSquareIcon,           // Reemplaza PencilIcon
    TrashIcon
...
export default function Dashboard() {
    ...
    return (
        <AuthenticatedLayout>
            <section className="w-full bg-gradient-to-r from-[#9e2a2f] to-[#9e2a2f] py-12 px-6">
                ...
                <div className="bg-white overflow-hidden shadow-lg sm:rounded-xl">
                    <div className="p-6">
                        <h2 className="text-2xl font-semibold text-gray-900 mb-4">
                            <UsersIcon className="h-6 w-6 inline-block mr-2 text-[#9e2a2f]" />
                            Treballadors
                        </h2>
                        {workers.length > 0 ? (
