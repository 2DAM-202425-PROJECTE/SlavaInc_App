...
const EditPlan = ({ plan }) => {
    const { data, setData, put, processing, errors } = useForm({
        ...
        can_view_stats: plan.can_view_stats || false,
        extra_stats: plan.extra_stats || false,
    })
                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div className="p-6 border-b border-gray-200">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-gray-800">Editar Pla</h1>
                                <p className="text-gray-500 mt-1">Modifica les dades del pla</p>
                            </div>
                        </div>
                    </div>
