                    ...
                    <div className="divide-y divide-gray-200">
                        {filteredUsers.length > 0 ? (
                                    ...
                                    <div key={user.id} className="p-6 hover:bg-gray-50 transition-colors duration-150">
                                        <div
                                            ...
                                            <div className="flex items-start gap-4">
                                                <div
                                                    className="hidden sm:flex h-12 w-12 rounded-full bg-blue-100 text-blue-600 items-center justify-center flex-shrink-0">
                                                    <UserCircle size={28}/>
                                                </div>
                                                <div>
                                                    <div className="flex items-center gap-2 mb-1">
                                                        ...
                                                        {isCurrentUser && (
                                                            <span
                                                                className="bg-blue-100 text-blue-800 text-xs px-2 py-0.5 rounded-full border border-blue-200">
                                Tu
                              </span>
                                                        )}
                                                        <span
                            ...
                            <div className="p-12 text-center">
                                ...
                                <p className="text-gray-500">Prova amb uns altres termes de cerca o crea un nou
                                    usuari.</p>
                            </div>
                        )}
                    </div>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full">
                        ...
                        <p className="text-gray-600 mb-6">
                            Estàs segur que vols eliminar aquest usuari? Aquesta acció no es pot desfer i s'eliminaran
