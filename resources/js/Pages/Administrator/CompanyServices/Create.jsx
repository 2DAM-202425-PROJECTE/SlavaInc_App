...
const CompanyServicesCreate = ({ companies, services }) => {
    ...
    const [priceType, setPriceType] = useState("per_unit") // per_unit, range, min, max
    ...
    const handleServiceSelect = (service) => {
        ...
        setFormData((prev) => ({
            ...
            custom_name: service.name, // Pre-fill custom name with service name
        }))
                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div className="p-6 border-b border-gray-200">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-gray-800">Crear Servei d'Empresa</h1>
                                <p className="text-gray-500 mt-1">Afegeix un nou servei personalitzat per a una empresa</p>
                            </div>
                        </div>
                    </div>
...
export default CompanyServicesCreate
