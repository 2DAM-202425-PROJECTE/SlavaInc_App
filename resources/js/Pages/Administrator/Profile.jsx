...
const Profile = ({ auth }) => {
                ...
                <div className="flex-grow flex items-center justify-center">
                    <div className="text-center p-8 max-w-md">
                        ...
                        <p className="text-gray-600 mb-6">
                            No s'ha pogut carregar la informació del teu perfil. Si us plau, torna a iniciar sessió o contacta amb
                            suport tècnic.
                        </p>
                        <div className="flex justify-center space-x-4">
                            ...
                            <Link href="/support" className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded">
                                Contactar suport
                            </Link>
                        </div>
                    </div>
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white">
                            ...
                            <div className="lg:w-2/3 p-8">
                                ...
                                <div className="mb-8">
                                    <div className="flex justify-between items-center mb-6">
                                        <h2 className="text-2xl font-bold pb-2 border-b" style={{ borderColor: secondaryColor }}>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="bg-gray-50 p-5 rounded-lg hover:shadow-md transition-shadow duration-300">
                                            <div className="flex items-center gap-3">
                                                <FontAwesomeIcon icon={faCalendarAlt} className="text-xl" style={{ color: secondaryColor }} />
                                                <div>
                                                    <p className="font-semibold text-gray-800">Data de creació</p>
                                                    <p className="text-gray-600">
                                                        {adminData.created_at
                                                            ? new Date(adminData.created_at).toLocaleDateString("ca-ES", {
                                                                year: "numeric",
                                                                month: "long",
                                                                day: "numeric",
                                                            })
                                        ...
                                        <div className="bg-gray-50 p-5 rounded-lg hover:shadow-md transition-shadow duration-300">
                                            <div className="flex items-center gap-3">
                                                <FontAwesomeIcon icon={faCalendarAlt} className="text-xl" style={{ color: secondaryColor }} />
                                                <div>
                                                    <p className="font-semibold text-gray-800">Última actualització</p>
                                                    <p className="text-gray-600">
                                                        {adminData.updated_at
                                                            ? new Date(adminData.updated_at).toLocaleDateString("ca-ES", {
                                                                year: "numeric",
                                                                month: "long",
                                                                day: "numeric",
                                                            })
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <button
                                            onClick={() => document.getElementById("securityModal").showModal()}
                                            className="bg-gray-50 p-5 rounded-lg hover:shadow-md transition-all duration-300 border border-transparent hover:border-[#3b82f6] text-left"
                                        >
                                            <div className="flex items-start gap-3">
                                                <FontAwesomeIcon
                                                ...
                                                />
                                                <div>
                                                    <h3 className="font-semibold text-gray-800 mb-2">Seguretat del compte</h3>
                                                    <p className="text-gray-600 text-sm">
                                                        Configura opcions de seguretat addicionals per al teu compte
                                                    </p>
                                                </div>
                                            </div>
                                        </button>
                                        ...
                                        <button
                                            onClick={() => document.getElementById("activityModal").showModal()}
                                            className="bg-gray-50 p-5 rounded-lg hover:shadow-md transition-all duration-300 border border-transparent hover:border-[#3b82f6] text-left"
                                        >
                                            <div className="flex items-start gap-3">
                                                <FontAwesomeIcon icon={faHistory} className="text-xl mt-1" style={{ color: secondaryColor }} />
                                                <div>
                                                    <h3 className="font-semibold text-gray-800 mb-2">Historial d'activitat</h3>
                                                    <p className="text-gray-600 text-sm">Consulta l'historial d'activitat del teu compte</p>
                                                </div>
                                            </div>
                                        </button>
            ...
            {/* Modal para seguridad del cuenta */}
            <dialog id="securityModal" className="modal rounded-lg p-0 w-full max-w-md">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    <div className="p-6 bg-gradient-to-r from-blue-700 to-blue-500">
                        <h3 className="text-xl font-bold text-white">Seguretat del compte</h3>
                    </div>
                    ...
                    <div className="p-6">
                        <div className="space-y-6">
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mb-3">
                                    Afegeix una capa addicional de seguretat al teu compte requerint més que només una contrasenya per
                                    iniciar sessió.
                                </p>
                                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-sm">
                                    Configurar autenticació de dos factors
                                </button>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mb-3">Revisa i tanca sessions actives en altres dispositius.</p>
                                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-sm">
                                    Gestionar sessions
                                </button>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mb-3">
                                    Configura opcions avançades de seguretat per al teu compte.
                                </p>
                                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-sm">
                                    Configurar opcions avançades
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-end mt-6">
                            <button
                                ...
                                onClick={() => document.getElementById("securityModal").close()}
                            >
                                Tancar
                            </button>
                        </div>
            ...
            {/* Modal para historial de actividad */}
            <dialog id="activityModal" className="modal rounded-lg p-0 w-full max-w-3xl">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    <div className="p-6 bg-gradient-to-r from-blue-700 to-blue-500">
                        <h3 className="text-xl font-bold text-white">Historial d'activitat</h3>
                    </div>

                    <div className="p-6">
                        <div className="space-y-4">
                            <div className="flex justify-between items-center">
                                <div className="text-sm text-gray-500">Mostrant les últimes activitats del teu compte</div>
                                <div>
                                    <select className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2">
                                        <option>Totes les activitats</option>
                                        <option>Inicis de sessió</option>
                                        <option>Canvis de configuració</option>
                                        <option>Accions administratives</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div className="overflow-hidden border border-gray-200 rounded-lg">
                                <table className="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Inici de sessió</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Avui, 10:23</td>
                                    ...
                                    <tr>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Canvi de contrasenya</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Ahir, 15:45</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">192.168.1.1</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Firefox / Mac</td>
                                    </tr>
                                    <tr>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Actualització de perfil</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">12/05/2025, 09:30</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">192.168.1.1</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Safari / iOS</td>
                                    </tr>
                                    <tr>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Inici de sessió</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">10/05/2025, 14:15</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">192.168.1.1</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Chrome / Android</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div className="flex justify-between items-center">
                                <div className="text-sm text-gray-500">Mostrant 4 de 24 activitats</div>
                        ...
                        <div className="flex justify-end mt-6">
                            <button
                                className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded"
                                onClick={() => document.getElementById("activityModal").close()}
                            >
                                Tancar
                            </button>
                        </div>
