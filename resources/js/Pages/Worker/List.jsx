...
const WorkerList = ({workers, nextPageUrl}) => {
    ...
    const handleDeleteWorker = (workerId) => {
        // Assuming you have a delete confirmation modal in the parent component
        // You would call a function passed as a prop here
    ...
    return (
            ...
            <div className="space-y-8">
                    ...
                    {workers.map((worker) => (
                        ...
                        >
                            <div className="flex items-center mb-4">
                                <div
                                    className="w-12 h-12 rounded-full bg-[#9e2a2f]/10 flex items-center justify-center mr-4">
                ...
                {/* Botó per carregar més treballadors */}
                {nextPageUrl && (
                ...
                {/* Mostrar missatge si no hi ha treballadors */}
                {workers.length === 0 && (
